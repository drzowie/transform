...
def test_013_interpND_jacobian():
    ...
    # Test basic sampling
    # jacobian=1, method=2, bound=3, fillvalue=4, oblur=5, iblur=6, pad_pow=7,sv_limit=8
    a = interpND_jacobian(datasource, index=[3,4],jacobian=1, method=2, bound=3, fillvalue=4, oblur=5, iblur=6, pad_pow=7,sv_limit=8)
    #assert(a==43)
